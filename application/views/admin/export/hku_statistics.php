...
<div id='statisticsview-hku' class='side-body <?php echo getSideBodyClass(false); ?>'>
    ...
    <div class="row">
        <div class="col-sm-12">
            <h3>
                ...
                <?php eT("Statistics"); ?> <?php if($sno){?> ( Subject No.: <?php echo $sno ?> ) <?php } ?>
            </h3>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <?php echo CHtml::form(App()->createUrl('/admin/statistics/sa/statisticsBySno/', ['surveyid' => $surveyid]), 'post', array('autocomplete'=>'off')); ?>
                <div class="col-md-offset-3 col-md-6 col-sm-offset-1 col-sm-10">
                    <div id="panel-1" class="panel panel-primary" style="opacity: 1; top: 0px;">
                        <div class="panel-heading">
                            <div class="panel-title h4">Please Enter Subject No.</div>
                        </div> 
                        <div class="panel-body">
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-sm-8">
                                        <input type="text" id="sno" name="sno" value="<?php echo $sno ?>" class="form-control">
                                    </div>
                                    <button class="button btn-primary btn-lg" type="submit">Check</button>
                                </div>
                            </div>
        ...
        <div class="text-center">
            ...
            <a href="<?php echo $downloadpdf ?>" target="_blank" download><button class="button btn-warning btn-lg">Download</button></a>
            ...
            <!-- <a target="_blank" href="<?php echo App()->createUrl('/admin/statistics/sa/downloadStatisticsPDF/surveyid/'.$surveyid."/token/".$token) ?>"><button class="button btn-primary btn-lg">Preview</button></a> -->
        </div>
