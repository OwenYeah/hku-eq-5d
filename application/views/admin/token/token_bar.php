        ...
        <div class="col-md-10">
            ...
            <?php if( isset($token_bar['buttons']['view']) ): ?>
                ...
                <?php if (Permission::model()->hasSurveyPermission($oSurvey->sid, 'tokens', 'update') || Permission::model()->hasSurveyPermission($oSurvey->sid, 'surveysettings', 'update')): ?>
                    <a class="btn btn-default pjax admin-only" href='<?php echo $this->createUrl("admin/tokens/sa/managetokenattributes/surveyid/$oSurvey->sid"); ?>' role="button">
                ...
                <?php /*if (Permission::model()->hasSurveyPermission($oSurvey->sid, 'tokens', 'export')): ?>
                    <a class="btn btn-default pjax admin-only" href="<?php echo $this->createUrl("admin/tokens/sa/exportdialog/surveyid/$oSurvey->sid"); ?>" role="button">
                ...
                <!-- Export tokens to CSV file -->
                <a class="btn btn-default" href="<?php echo $this->createUrl("admin/tokens/sa/genReportOfAll/surveyid/$oSurvey->sid"); ?>" target="_blank">
                    <span class="icon-exportcsv"></span>
                    <?php eT("Export"); ?>
                </a>
                ...
                <!-- Generate tokens -->
                <a class="btn btn-default admin-only" href="<?php echo $this->createUrl("admin/tokens/sa/tokenify/surveyid/$oSurvey->sid"); ?>" role="button">
                    <span class="icon-do text-success"></span>
                    <?php eT("Generate tokens"); ?>
                </a>

                <!-- View participants of this survey in CPDB -->
                <a class="btn btn-default admin-only" href="#" role="button" onclick="sendPost('<?php echo $this->createUrl("/admin/participants/sa/displayParticipants"); ?>','',['searchcondition'],['surveyid||equal|| <?php echo $oSurvey->sid ?>']);">
