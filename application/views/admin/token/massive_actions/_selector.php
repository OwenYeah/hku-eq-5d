    ...
    $this->widget('ext.admin.grid.MassiveActionsWidget.MassiveActionsWidget', array(
            ...
            'aActions'    => array(
                ...
                array(
                    ...
                    'type'        => 'action',
                    'action'      => 'edit',
                    'url'         =>  App()->createUrl('/admin/tokens/sa/genQrCode'),
                    'iconClasses' => 'text-success fa fa-qrcode',
                    'text'        =>  gT('Generate QR-Code'),
                    'grid-reload' => 'yes',
                    ...
                    'no'            => gT('Cancel'),
                    'keepopen'      => 'yes',
                    'sModalTitle'   => gT('Generate QR-Code'),
                    'htmlModalBody' => gT('Are you sure you want to generate QR-Code for the selected participants?'),
                    'aCustomDatas'  => array(
                        array( 'name'=>'sid',  'value'=> $_GET['surveyid']),
                    ),
                ),
