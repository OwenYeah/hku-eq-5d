...
class SurveyAdmin extends Survey_Common_Action
{
    ...
    public function listsurveys()
    {
        ...
        if (!Permission::model()->hasGlobalPermission('superadmin', 'read')) {
            // Owen: redirect to survey page, if the user is not admin
            $this->getController()->redirect(array("/admin/statistics/sa/statisticsByToken/surveyid/716222"));
        }
...
//If we're doing this by group, restart the numbering when the group number changes
    ...
    public function view($iSurveyID, $gid = null, $qid = null)
    {
        // owen
        if (!Permission::model()->hasGlobalPermission('superadmin', 'read')) {
            // $this->getController('admin/statistics')->redirect('sa/index/surveyid/716222');
            $this->getController()->redirect(array("/admin/statistics/sa/statisticsByToken/surveyid/716222"));
        }
        // owen
