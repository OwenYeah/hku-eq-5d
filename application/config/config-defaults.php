...
// Styling options
$config['admintheme']         = 'The_University_Of_Hong_Kong'; // This setting specifys the directory where the admin finds it theme/css style files, e.g. setting 'default' points to /admin/styles/default
...
$config['fontdir']                  = $config['rootdir'].DIRECTORY_SEPARATOR."assets".DIRECTORY_SEPARATOR."fonts"; // The directory path of the image directory
